...
<hr>
		...
		<div class="col-md-2"></div>
				<div class="well login-container col-md-8" style="margin-top: -8px;">
					...
					{ ?>
						<div class="col-md-3">
							<img src="photos/<?php echo $fetch['Image']; ?>" class="img-circle" height="250px" width="250px">
						</div>
