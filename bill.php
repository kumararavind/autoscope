...
<hr>
		...
		<div class="col-md-2"></div>
				<div class="well login-container col-md-8" style="margin-top: -8px;">
						<table class="table table-bordered table-striped table-hover" style="background-color: white; color: black;">
								<tr>
									<th>Sl No.</th>
									<th>For Service</th>
									<th>Bill Date</th>
								...
								$i=1;
									$qry=mysql_query("select * from service_request, assign_work, bill where bill.Work_ID=assign_work.Work_ID and service_request.Service_rqst_id=assign_work.Sreqst_ID and bill.User_ID='$uid'") or die(mysql_error());
								 ...
								 <tr>
								 	...
								 	<td><a href="bill_details.php?billid=<?php echo $row['billid']; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a></td>
								 </tr>
								 <?php } ?>
							</table>
				</div>
